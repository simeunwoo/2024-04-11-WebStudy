...
window.onload=()=>{
	...
	// get => GET, post => POST
	axios.get("http://localhost:8080/JavaScriptProject_3/js/food_find_js.do").then((response)=>{
...
function detail(fno){
	axios.get("http://localhost:8080/JavaScriptProject_3/js/food_detail_js.do",{
		params:{
			fno:fno
		}
