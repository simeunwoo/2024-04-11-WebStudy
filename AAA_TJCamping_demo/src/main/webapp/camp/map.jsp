...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const subButtons = {
        	gyeonggi = ['고양', '광주', '김포', '남양주', '동두천', '부천', '성남', '수원', '시흥', '안산', '안성', '안양', '양주', '여주', '오산', '용인', '의정부', '이천', '파주', '평택', '포천', '하남', '화성']
        	chungbuk = ['괴산', '단양', '보은', '영동', '옥천', '음성', '제천', '진천', '청주', '충주', '증평']
        	chungnam = ['공주', '금산', '논산', '당진', '보령', '부여', '서산', '서천', '아산', '예산', '천안', '청양', '태안', '홍성']
