...
public class BoardReplyDAO {
	...
	public static List<BoardReplyVO> replyListData(int bno)
	{
		...
		{
			System.out.println("BoardReplyDAO 오류 1");
			ex.printStackTrace();
		}
		finally
		{
	...
	<insert id="replyInsert" parameterType="BoardReplyVO">
		...
		VALUES((SELECT NVL(MAX(rno)+1,1) FROM project_board_reply),
	...
	public static void replyInsert(BoardReplyVO vo)
	{
		...
		{
			System.out.println("BoardReplyDAO 오류 2");
			ex.printStackTrace();
		}
		finally
		{
	...
	public static void replyDelete(int rno)
	{
		...
		{
			System.out.println("BoardReplyDAO 오류 3");
			ex.printStackTrace();
		}
		finally
		{
