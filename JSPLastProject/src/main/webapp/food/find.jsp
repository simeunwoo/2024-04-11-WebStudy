	      ...
	      <nav class="pagination">
	        <ul>
	        	...
	        	<c:if test="${startPage>1 }">
		          <li><a href="../food/find.do?page=${startPage-1 }">&laquo; Previous</a></li>
		        </c:if>
		        <c:forEach var="i" begin="${startPage }" end="${endPage }">
		          <li ${i==curpage?"class=current":"" }><a href="../food/find.do?page=${i }">${i }</a></li>
		        </c:forEach>
		        <!-- endPage = 10 20 30 ... -->
		        <c:if test="${endPage<totalpage }">
		          <li><a href="../food/find.do?page=${endPage+1 }">Next &raquo;</a></li>
	          	</c:if>
	        </ul>
	      </nav>
	      <!-- ################################################################################################ --> 
