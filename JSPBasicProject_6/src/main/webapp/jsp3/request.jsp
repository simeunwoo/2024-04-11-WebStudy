...
<%--
    사용자가 전송하는 모든 데이터는 서버를 거쳐서 톰캣에 의하여 request에 전송되어 묶여서 넘겨준다
                                           =========================
                                           => 처리를 웹 개발자가 한다
	묶는 방법 => Map 방식이다
	         ======== 키, 값 => getParameter("키")
	         list.jsp?num=1&num1=2&num2=3&num3=4&num4=5
