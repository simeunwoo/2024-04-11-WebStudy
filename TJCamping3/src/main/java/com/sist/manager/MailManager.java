...
public class MailManager {
	...
	/*
	 * private String style="body{" +"padding:1.5em;" +"background:#F5F5F5;" +"}"
	 * +"table{" +"border:1px #EDEDED solid;" +"font-size:.9em;"
	...
	public void mailSender(String result) {
		...
		String user="jungyuyeop@naver.com";
		...
		try {
			...
			message.addRecipient(Message.RecipientType.TO, new InternetAddress("jungyuyeop@naver.com"));
