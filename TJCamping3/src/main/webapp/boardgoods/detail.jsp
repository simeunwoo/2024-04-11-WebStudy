	 ...
	 $('#deleteBtn').on('click',function(){
		 ...
		 $.ajax({
			...
			success:function(result)
			{
				...
				{
					// 이동 
					location.href="../boardgoods/list.do"
				}
				else
				{
				   alert("비밀번호가 틀립니다!!")
...
<body>
	...
	<table class="table">
		<tr>
			...
			<nav>
				<a href="../boardgoods/update.do?no=${vo.no }" class="btn btn-xs btn-success" >수정</a>
				<span class="btn btn-xs btn-warning" id="delBtn">삭제</span>
				<a href="../boardgoods/list.do" class="btn btn-xs btn-info">목록</a>
			</nav>
			</td>
		</tr>
       ...
       <tr>
         ...
         <!-- 이미지 삽입 -->
          ...
          <div style="text-align: center; bottom:0px;">
          		<a href="../boardgoods/list.do" class="btn btn-xs btn-info">목록으로</a>
          		&nbsp;
