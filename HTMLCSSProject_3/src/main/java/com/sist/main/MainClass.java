...
public class MainClass {
	...
	public void footData()
	{
		...
		try
		{
			...
			for(int i=1;i<=347;i++)
			{
				Document doc=Jsoup.connect("https://www.menupan.com/restaurant/bestrest/bestrest.asp?page"+i+"=347&trec=8674&pt=rt").get();
			...
			System.out.println("저장 완료! Siuuuuuuuuuuuuuuuu!!!!!!!!!!!!!!!");
		}catch(Exception ex) {}
	}
